...
namespace EVServiceCenter.Repositories.ThanNTH.Basic;
public class GenericRepository<T> where T : class
{
    protected FA25_PRN232_SE1717_G3_EVServiceCenterContext _context;
    ...
    public GenericRepository(FA25_PRN232_SE1717_G3_EVServiceCenterContext context)
    {
        _context = context;
    }
